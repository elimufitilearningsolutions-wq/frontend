...
const PrimaryLessonPlans = ({ isLoggedIn, clearToken }) => {
    const items = [
        ...
        { name: 'PRIMARY LESSON PLANS 2024 ', year: 2024, bgColor: 'rgba(0, 0, 0, 0.2)', textColor: 'rgb(0, 0, 0)', path: "primary", value: "lesson/plans" },
        { name: 'PRIMARY LESSON PLANS 2023 ', year: 2023, bgColor: 'rgba(0, 0, 0, 0.1)', textColor: 'rgb(0, 0, 0)', path: "primary", value: "lesson/plans" }
    ];
