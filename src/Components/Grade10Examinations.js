...
const Grade10Examinations = ({ isLoggedIn, clearToken }) => {
    const items = [
        ...
        { name: 'GRADE 10 EXAMINATIONS 2024', year: 2024, bgColor: 'rgba(0, 0, 0, 0.2)', textColor: 'rgb(0, 0, 0)', path: "senior/school", value: "grade10/examinations" },
        { name: 'GRADE 10 EXAMINATIONS 2023', year: 2023, bgColor: 'rgba(0, 0, 0, 0.1)', textColor: 'rgb(0, 0, 0)', path: "senior/school", value: "grade10/examinations" }
    ];
