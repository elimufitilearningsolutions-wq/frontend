...
const Grade3Examinations = ({ isLoggedIn, clearToken }) => {
    const items = [
        { name: 'GRADE 3 EXAMINATIONS 2026 ', year: 2026, bgColor: 'rgba(0, 0, 0, 0.2)', textColor: 'rgb(0, 0, 0)', path: "primary", value: "grade3/examinations" },
        { name: 'GRADE 3 EXAMINATIONS 2025 ', year: 2025, bgColor: 'rgba(0, 0, 0, 0.1)', textColor: 'rgb(0, 0, 0)', path: "primary", value: "grade3/examinations" },
