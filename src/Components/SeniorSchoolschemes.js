...
const SeniorSchoolSchemes = ({ isLoggedIn, clearToken }) => {
    const items = [
        ...
        { name: 'SENIOR SCHOOLS SCHEMES 2024', year: 2024, bgColor: 'rgba(0, 0, 0, 0.2)', textColor: 'rgb(0, 0, 0)', path: "senior/school", value: "schemes" },
        { name: 'SENIOR SCHOOLS SCHEMES 2023', year: 2023, bgColor: 'rgba(0, 0, 0, 0.1)', textColor: 'rgb(0, 0, 0)', path: "senior/school", value: "schemes" }
    ];
